...
Extract URL(s) from user's input. Handle multiple URLs if provided.
...
After downloading, run organize-attachments command to rename files with
descriptive names:
