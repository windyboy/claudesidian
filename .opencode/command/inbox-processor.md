---
agent: read-only
description: Organize and process items in 00_Inbox folder using PARA method
---

# Inbox Processor

Help organize and process items in 00_Inbox folder according to PARA
method.
...
- Some items legitimately belong in Inbox (daily notes, quick captures)
