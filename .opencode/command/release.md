---
agent: bootstrap
description: Automatically bump version, update changelog, commit, tag, and push release
...
entries to new version, commits everything, creates a git tag, and pushes to
GitHub.
...
3. Move "Unreleased" entries in CHANGELOG.md to new version section
4. Commit changes
...
5. **Create GitHub Release**
   - Use `gh release create` to publish release automatically
   - Extract version section from CHANGELOG.md for release notes
   - Include "Generated with OpenCode" footer
   - This ensures that the release is visible in GitHub's releases page
